pipeline {
    ...
    environment {
        ...
        TF_VAR_access_key = credentials('AKIAXEFUNJKKAVSRU2RV') // Manage credentials in Jenkins
        TF_VAR_secret_key = credentials('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')
    }
